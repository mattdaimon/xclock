...
- 現行版: v1.1.0
- v1.0.1 の標準表示を維持し、任意の秒針表示を追加した
- 本書には v1.1.0 で実装した値と動作を記録する
...
- ひし形の前後方向の全長は半径の 9%
- ひし形の左右方向の全幅は半径の 5%
- ひし形の前端から秒針先端まで、半径の 3.5%の線が残る
- 秒針は分針より長い
- 線幅には 1 CSS px の下限を設ける

## 12. v1.1.0 の針の動き

秒針表示時は、針の動きをオリジナル xclock へ寄せる。
...
`MAJOR.MINOR.PATCH` の慣例により、互換性を維持した新機能として MINOR を上げる。
